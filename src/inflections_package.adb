...
package body NOUN_RECORD_IO is
  ...
  begin
    PUT(F, DECL_TO_XML(N.DECL, TRUE));
    PUT(F, CASE_TO_XML(N.CS));
    PUT(F, NUMBER_TO_XML(N.NUMBER));
    PUT(F, GENDER_TO_XML(N.GENDER));
  end PUT;
...
package body PRONOUN_RECORD_IO is
  ...
  begin
    PUT(F, DECL_TO_XML(P.DECL, TRUE));
    PUT(F, CASE_TO_XML(P.CS));
    PUT(F, NUMBER_TO_XML(P.NUMBER));
    PUT(F, GENDER_TO_XML(P.GENDER));
  end PUT;
...
package body ADJECTIVE_RECORD_IO is
  ...
  begin
    PUT(F, DECL_TO_XML(A.DECL, TRUE));
    PUT(F, CASE_TO_XML(A.CS));
    PUT(F, NUMBER_TO_XML(A.NUMBER));
    PUT(F, GENDER_TO_XML(A.GENDER));
    PUT(F, COMPARISON_TO_XML(A.CO));
  end PUT;
...
package body NUMERAL_RECORD_IO is
  ...
  begin
    PUT(F, DECL_TO_XML(NUM.DECL, TRUE));
    PUT(F, CASE_TO_XML(NUM.CS));
    PUT(F, NUMBER_TO_XML(NUM.NUMBER));
    PUT(F, GENDER_TO_XML(NUM.GENDER));
    PUT(F, NUMERAL_SORT_TO_XML(NUM.SORT));
  end PUT;
...
package body VERB_RECORD_IO is
  ...
  begin
    PUT(F, CONJ_TO_XML(V.CON, TRUE));
    PUT(F, TENSE_VOICE_MOOD_TO_XML(V.TENSE_VOICE_MOOD));
    PUT(F, PERSON_TO_XML(V.PERSON));
    PUT(F, NUMBER_TO_XML(V.NUMBER));
  end PUT;
...
package body VPAR_RECORD_IO is
  ...
  begin
    PUT(F, CONJ_TO_XML(VP.CON, TRUE));
    PUT(F, CASE_TO_XML(VP.CS));
    PUT(F, NUMBER_TO_XML(VP.NUMBER));
    PUT(F, GENDER_TO_XML(VP.GENDER));
    PUT(F, TENSE_VOICE_MOOD_TO_XML(VP.TENSE_VOICE_MOOD));
  end PUT;
...
package body QUALITY_RECORD_IO is
  ...
  begin
    PUT(F, PART_OF_SPEECH_TO_XML(P.POFS));
    case P.POFS is
      when N =>
        PUT(F, P.N);
      when PRON =>
...
--  computes the LELL..LELF indices for use in WORD
  ...
  begin
    OPEN(INFLECTIONS_SECTIONS_FILE,
         IN_FILE,
         ADD_FILE_NAME_EXTENSION(INFLECTIONS_SECTIONS_NAME));
